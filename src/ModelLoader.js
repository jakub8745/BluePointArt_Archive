...
class ModelLoader {
    ...
    constructor(deps, scene, newFloor) {
        ...
        this.dracoLoader = new DRACOLoader(this.manager).setDecoderPath('three/addons/libs/draco/');
        ...
        this.ktx2Loader = deps.ktx2Loader.setTranscoderPath('three/addons/libs/basis/');
